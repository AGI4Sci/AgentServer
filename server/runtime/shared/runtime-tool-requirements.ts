...
const ENGLISH_RUNTIME_TOOL_PATTERNS = [
  ...
  /\b(?:append_file|read_file|write_file|list_dir|grep_search|run_command|apply_patch|web_search|web_fetch|browser_open|browser_activate)\b/,
  ...
  /\bexecute\s+`(?:append_file|read_file|write_file|list_dir|grep_search|run_command|apply_patch|web_search|web_fetch|browser_open|browser_activate)\b/,
  /\bcreate (?:the )?file\b/,
